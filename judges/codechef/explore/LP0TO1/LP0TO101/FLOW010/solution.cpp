 ...
 * FILE DESCRIPTION
 *
 *        Filename: FLOW010/solution.cpp
 *      Created on: 04 September 2022
 *   Last modified: 04 September 2022
 *          Author: sonapraneeth_a
 *     Description: CODECHEF submission for 'Id and Ship' problem
...
class Solution {
 ...
 protected:
     ...
     *
     * Parameters:
     *  - id: char - Character representation of ship
     *
     * Returns:
     *  - string - Class description of ship
     */
    // clang-format on
    virtual string solve(char id) = 0;
 ...
 *
 * Judge metadata:
 *  - Submission link: https://www.codechef.com/viewsolution/73072836
