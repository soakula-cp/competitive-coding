 ...
 * FILE DESCRIPTION
 *
 *        Filename: LUCKFOUR/solution.cpp
 *      Created on: 05 September 2022
 *   Last modified: 05 September 2022
 *          Author: soakula_cp
 *     Description: CODECHEF submission for 'Lucky Four' problem
...
class Solution {
 ...
 protected:
     ...
     *
     * Returns:
     *  - int - Number of occurences of '4' in N
     */
    // clang-format on
 ...
 *
 * Judge metadata:
 *  - Submission link: https://www.codechef.com/viewsolution/73087809
 *  - Status: Correct Answer
 *  - Runtime: 0.017781 sec
 *  - Memory usage: 5.4 M
 * Algorithm metadata:
...
class Solution_01 : public Solution {
 protected:
     ...
     * FUNCTION DESCRIPTION
     *
     * Time complexity: O(log(N)) ~ O(log(10^9)) ~ O(9) ~ O(1), where N is the input
     * Space complexity: O(1)
     * Additional notes
     *  -
     */
 ...
 *
 * Judge metadata:
 *  - Submission link: https://www.codechef.com/viewsolution/73087819
 *  - Status: Correct Answer
 *  - Runtime: 0.019109 sec
 *  - Memory usage: 5.2 M
 * Algorithm metadata:
...
class Solution_02 : public Solution {
 protected:
    ...
    int solve(int N) override {
        ...
        return std::count(begin(number), end(number), '4');
    }
};
