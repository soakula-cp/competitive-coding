 ...
 * FILE DESCRIPTION
 *
 *        Filename: ALTER/solution.cpp
 *      Created on: 11 September 2022
 *   Last modified: 11 September 2022
 *          Author: soakula_cp
 *     Description: CODECHEF submission for 'Alternating Work Days' problem
...
class Solution {
 ...
 protected:
     ...
     *
     * Parameters:
     *  - A: int - Initial skill level of Alice
     *  - B: int - Initial skill level of Bob
     *  - P: int - Required skill level of Alice
     *  - Q: int - Required skill level of Bob
     *
     * Returns:
     *  - bool - true if skill level of Bob and Alice can be attained some day
     *           else false
     */
    // clang-format on
    virtual bool solve(int A, int B, int P, int Q) = 0;
 ...
 *
 * Judge metadata:
 *  - Submission link: https://www.codechef.com/viewsolution/73831178
 *  - Status: Correct Answer.
 *  - Runtime: 0.004024 sec
 *  - Memory usage: 5.1 M
 * Algorithm metadata:
...
class Solution_01 : public Solution {
 protected:
     ...
     */
    // clang-format on
    virtual bool solve(int A, int B, int P, int Q) {
        if (P % A == 0 && Q % B == 0) {
            return abs((P / A) - (Q / B)) <= 1;
        }
        return false;
    }
};
