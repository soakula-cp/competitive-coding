 ...
 * FILE DESCRIPTION
 *
 *        Filename: MAKEDIV3/solution.cpp
 *      Created on: 11 September 2022
 *   Last modified: 11 September 2022
 *          Author: soakula_cp
 *     Description: CODECHEF submission for 'Make it Divisible' problem
...
class Solution {
 ...
 protected:
     ...
     *
     * Parameters:
     *  - N: int - Number of digits in output number
     *
     * Returns:
     *  - string - Number which is divisible by 3 and not 9
     */
    // clang-format on
    virtual string solve(int N) = 0;
 ...
 *
 * Judge metadata:
 *  - Submission link: https://www.codechef.com/viewsolution/73786845
 *  - Status: Correct Answer.
 *  - Runtime: 0.003844 sec
 *  - Memory usage: 5.3 M
 * Algorithm metadata:
 *  - Time complexity: O(T*O(N)) ~ O(T*N), where T is the number of test cases and N is number of digits
 *  - Space complexity: O(1)
 *  - Tags:
 *  - Categories:
 * Additional notes
