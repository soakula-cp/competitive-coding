 ...
 * FILE DESCRIPTION
 *
 *        Filename: FEVER/solution.cpp
 *      Created on: 07 September 2022
 *   Last modified: 07 September 2022
 *          Author: soakula_cp
 *     Description: CODECHEF submission for 'Fever' problem
...
class Solution {
 ...
 protected:
     ...
     *
     * Parameters:
     *  - X: int - Temperature in Farenheit
     *
     * Returns:
     *  - bool - true if chef has fever else false
     */
    // clang-format on
    virtual bool solve(int X) = 0;
 ...
 *
 * Judge metadata:
 *  - Submission link: https://www.codechef.com/viewsolution/73440558
 *  - Status: Correct Answer
 *  - Runtime: 0.003767 sec
 *  - Memory usage: 5.4 M
 * Algorithm metadata:
...
class Solution_01 : public Solution {
 protected:
     ...
     */
    // clang-format on
    bool solve(int X) override { return X > 98; }
};
