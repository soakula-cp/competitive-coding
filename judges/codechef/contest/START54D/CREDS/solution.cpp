 ...
 * FILE DESCRIPTION
 *
 *        Filename: CREDS/solution.cpp
 *      Created on: 04 September 2022
 *   Last modified: 04 September 2022
 *          Author: sonapraneeth_a
 *     Description: CODECHEF submission for 'Number of Credits' problem
...
class Solution {
 ...
 protected:
     ...
     *
     * Returns:
     *  - int - Number of credits obtained in this semester
     */
    // clang-format on
 ...
 *
 * Judge:
 *  - Submission link: https://www.codechef.com/viewsolution/73064871
 *  - Status: Correct Answer
 *  - Runtime: 0.003889 sec
 *  - Memory usage: 5.4 M
...
class Solution_01 : public Solution {
 protected:
     ...
     */
    // clang-format on
    int solve(int X, int Y, int Z) override { return (X << 2) + (Y << 1); }
};
